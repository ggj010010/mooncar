...
<!--상단 (공통) -->
   <h1 align = "center"><img class="btn-img" src="/resources/js/image/rogo.png">MoonCar <button class="btn" id="btn" type="button" onclick="window.open('/popup/userpop', '_blank', 'toolbars=no,scrollbars=no'); return false;" 
